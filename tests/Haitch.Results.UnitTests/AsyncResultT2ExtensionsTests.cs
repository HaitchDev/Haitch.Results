...
public class AsyncResultT2ExtensionsTests
{
    ...
    public async Task MapAsync_TaskSource_AsyncMapper_returns_mapped_value_when_successful()
    {
        ...
        await output.AssertSuccess("value:42");
    }
    ...
    #region MapErrorAsync — extension(Task<Result<TValue, TError>> source)
    ...
    #region MapErrorAsync — extension(Result<TValue, TError> source)
    ...
    #region BindAsync — extension(Task<Result<TValue, TError>> source)
    ...
    public async Task BindAsync_TaskSource_AsyncBinder_returns_bound_value_when_successful()
    {
        ...
        var output = await resultTask.BindAsync(v => Task.FromResult(Result<string, Error>.Success($"value:{v}")));
    ...
    public async Task BindAsync_TaskSource_SyncBinder_returns_bound_value_when_successful()
    {
        ...
        var output = await resultTask.BindAsync(v => Result<string, Error>.Success($"value:{v}"));
    ...
    #region BindAsync — extension(Result<TValue, TError> source)
    ...
    public async Task BindAsync_ResultSource_AsyncBinder_returns_bound_value_when_successful()
    {
        ...
        var output = await result.BindAsync(v => Task.FromResult(Result<string, Error>.Success($"value:{v}")));
    ...
    public async Task BindAsync_ResultSource_SyncBinder_returns_bound_value_when_successful()
    {
        ...
        var output = await result.BindAsync(v => Result<string, Error>.Success($"value:{v}"));
    ...
    #region TapAsync — extension(Task<Result<TValue, TError>> source)
    ...
    public async Task TapAsync_TaskSource_AsyncAction_does_not_invoke_action_when_failed()
    {
        ...
        var output = await resultTask.TapAsync(_ => { tapped = true; return Task.CompletedTask; });
    ...
    public async Task TapAsync_TaskSource_SyncAction_does_not_invoke_action_when_failed()
    {
        ...
        var output = await resultTask.TapAsync(_ => { tapped = true; });
    ...
    #region TapAsync — extension(Result<TValue, TError> source)
    ...
    public async Task TapAsync_ResultSource_AsyncAction_does_not_invoke_action_when_failed()
    {
        ...
        var output = await result.TapAsync(_ => { tapped = true; return Task.CompletedTask; });
    ...
    public async Task TapAsync_ResultSource_SyncAction_does_not_invoke_action_when_failed()
    {
        ...
        var output = await result.TapAsync(_ => { tapped = true; });
    ...
    #region TapErrorAsync — extension(Task<Result<TValue, TError>> source)
    ...
    #region TapErrorAsync — extension(Result<TValue, TError> source)
    ...
    #region EnsureAsync — extension(Task<Result<TValue, TError>> source)
    ...
    public async Task EnsureAsync_TaskSource_AsyncPredicate_propagates_error_when_already_failed()
    {
        ...
        var output = await resultTask.EnsureAsync(_ => Task.FromResult(true), Error.NotFound("nf", "not found"));
    ...
    public async Task EnsureAsync_TaskSource_SyncPredicate_propagates_error_when_already_failed()
    {
        ...
        var output = await resultTask.EnsureAsync(_ => true, Error.NotFound("nf", "not found"));
    ...
    #region EnsureAsync — extension(Result<TValue, TError> source)
    ...
    public async Task EnsureAsync_ResultSource_AsyncPredicate_propagates_error_when_already_failed()
    {
        ...
        var output = await result.EnsureAsync(_ => Task.FromResult(true), Error.NotFound("nf", "not found"));
    ...
    public async Task EnsureAsync_ResultSource_SyncPredicate_propagates_error_when_already_failed()
    {
        ...
        var output = await result.EnsureAsync(_ => true, Error.NotFound("nf", "not found"));
